...
TESTed1cu5ohNg3majahY0qu;0;1;Import group 2
...
TESTMeevuighohda4ungai0d;0;1;Import group 1
TESTed1cu5ohNg3majahY0qu;1;0;Import group 3
TESToThenedaiwiek0aiRi2A;0;0
TESTphoo0poh3feYoo3uwoox;1;1
TESThieroleJohgh8Die3oci;1;1;Import group 1;Import group 2;Import group 3
EOF;6
EOT;
file_put_contents("import_members_test.csv", $data);
system("./import_members.php import_members_test.csv");
