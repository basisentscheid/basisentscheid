				...
				<div class="col-md-10">
						...
						<nav class="navbar">
								<div class="navbar-header">
									...
									<a href="index.php" class="navbar-brand" id="logo" tabindex="-1"><img src="img/logo.png" alt=""></a>
									<span class="select_fm"><?
											Ngroup::display_switch();
											?>
									</span>
									<div id="user" class="mob_visible">
											<? html_user(); ?>
								...
								<div class="collapse navbar-collapse top_menu" id="navbar-collapse-1">
									<ul class="nav navbar-nav">
										<?
										navlink('index.php', _("Start"), true);
									...
									<ul class="nav navbar-nav manual">
										<?
...
?>
<img src="data:img/png;base64," alt="<?=_("eligible")?>" title="<?=_("You are eligible.")?>">
<?
			} else {
?>
<img src="data:img/png;base64," alt="<?=_("not eligible")?>" class="opacity_6" title="<?=_("You are not eligible.")?>">
<?
			}
			if (Login::$member->verified) {
?>
<img src="data:img/png;base64," alt="<?=_("verified")?>" title="<?=_("You are verified.")?>">

<?
			} else {
?>
<img src="data:img/png;base64," class="opacity_6" alt="<?=_("not verified")?>" title="<?=_("You are not verified.")?>">
<?
			}
		} else {
			printf(
...
function display_nav_settings() {
	help();
?>
<div class="admin_panel filter nav">
	<a href="settings.php"<?
...
?>
	<input type="submit" class="orange_but first" value="<?=h($value)?>">
<?
}
