...
<fieldset class="member">
	...
	<div class="input td1">
		...
		<span class="input"><input type="password" name="password" id="password" value="<?=h($password)?>" size="25" required> <input type="password" name="password2" value="<?=h($password)?>" size="25" required></span>
	</div>
